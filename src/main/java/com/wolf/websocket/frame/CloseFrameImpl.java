...
public class CloseFrameImpl extends FrameDataImpl implements CloseFrame {

    static final ByteBuffer emptybytebuffer = ByteBuffer.allocate(0);
    private int code;
    private String reason;

    public CloseFrameImpl() {
        super(Opcode.CLOSING);
        setFin(true);
    }

    public CloseFrameImpl(int code) throws InvalidDataException {
        super(Opcode.CLOSING);
        setFin(true);
        setCodeAndMessage(code, "");
    }

    public CloseFrameImpl(int code, String m) throws InvalidDataException {
        super(Opcode.CLOSING);
        setFin(true);
